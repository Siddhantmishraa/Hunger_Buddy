...
const Restaurant = () => {
  ...
  let getMenuList = async () => {
    let url = `https://hunger-buddy-api.vercel.app/api/get-menu-items-by-restaurant-id/${id}`;
  ...
  let makePayment = async () => {
    let url = `https://hunger-buddy-api.vercel.app/api/create-order-id`;
    ...
    var options = {
      ...
      handler: async function (response) {
        try {
          ...
          let url = `https://hunger-buddy-api.vercel.app/api/verify-payment`;
